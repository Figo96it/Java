...
public class KopiaZapasowa {
  ...
  private static void zapiszKsiazki(Biblioteka biblioteka) {
    ...
    for (Ksiazka ksiazka : biblioteka.getKsiazki()) {
      ...
      sw.append("autor.imie:" + ksiazka.getAutor().getImie() + ",");
      sw.append("autor.nazwisko:" + ksiazka.getAutor().getNazwisko() + ",");
      sw.append("liczba.stron:" + ksiazka.getLiczbaStron() + ",");
      sw.append("gatunek:" + ksiazka.getGatunek() + ",");
      sw.append("rok.wydania:" + ksiazka.getRokWydania() + ",");
