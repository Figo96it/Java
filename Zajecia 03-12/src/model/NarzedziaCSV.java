...
public class NarzedziaCSV {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(sciezkaDoPliku))) {
            ...
            while (linia != null) {
                if (naglowki == null) {
                    ...
                    if (wiersz.length != 13) {
                        System.out.println("Nieprawidlowy wiersz: " + linia);
                    ...
                    if(dataUrodzenia==null){
                        System.out.println("Nieprawidlowy format daty urodzenia: "+wiersz[7]);
                        linia=reader.readLine();
                        continue;
                    }
                    ...
                    if(samochod==null){
                        System.out.println("Nieprawidlowe dane samochodu: "+wiersz[9]);
                        linia=reader.readLine();
                        continue;
                    }
    ...
    private static LocalDate getDataUrodzenia(String rekord){
        ...
        //        .collect(Collectors.toList()).toArray(dataUr);
