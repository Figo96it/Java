...
public class KontrolerGUI {
    ...
    public void sortowanieBabelkowe(){ sortuj(new SortowanieBabelkowe());}
    public void sortowaniePrzezWstawienie(){ sortuj(new SortowaniePrzezWstawienie());}
    public void sortowaniePrzezWybor(){ sortuj(new SortowaniePrzezWybor());}
    public void sortowaniePrzezZliczanie(){ sortuj(new SortowaniePrzezZliczanie());}
    public void sortowanieSzybkie(){ sortuj(new SortowanieSzybkie());}
